...
1. Find out which graphics card you have:
   ...
   3. Edit the URL in your browser and append `README/supportedchips.html`. Then find the device number, e.g. `24b8` in the example above. Your NVIDIA card model will be written next to it.
