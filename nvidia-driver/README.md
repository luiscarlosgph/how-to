...
1. Find out which graphics card you have:
   ...
   2. Go [here](https://download.nvidia.com/XFree86/Linux-x86_64/) and click on the link corresponding to the last version of the driver (from the previous step), e.g. `515.76`.
