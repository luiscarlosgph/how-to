...
* What is a **Docker image**? Docker images act as a set of instructions to build a Docker container, like a template [1]. You can create and delete an image.
* What is a **Docker container**? A container is a runnable instance of an image. You can create, start, stop, or delete a container [2].
...
10. Access [https://127.0.0.1:9443](https://127.0.0.1:9443). The first time you do this, you will see this (or similar, depending on the web browser you use):
    ...
    Click `Accept the Risk and Continue`, you will never see this message again. After this, Portainer will prompt you for your new username and password (to access Portainer). Once you set that, enjoy!
