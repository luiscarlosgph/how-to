...
10. Access [https://127.0.0.1:9443](https://127.0.0.1:9443). The first time you do this, you will see this (or similar, depending on the web browser you use):
    ...
    Click `Accept the Risk and Continue`, you will never see this message again. After this, Portainer will prompt you for your new username and password (to access Portainer). Once you set that up, click the `Home` button on the left-hand side and enjoy!
